...
export default function TooltipLearn({ width, height, showControls = true }: TooltipProps) {
  ...
  const TooltipComponent = renderTooltipInPortal ? TooltipInPortal : tooltipShouldDetectBounds ? TooltipWithBounds : Tooltip;

  return (
    <>
      <div ref={containerRef} className="tooltip-example" style={{ width, height }} onPointerMove={handlePointerMove}>
        {tooltipOpen ? (
          <>
            <div
      ...
      {showControls && (
        <div className="tooltip-controls">
          <label>
            <input type="checkbox" checked={tooltipShouldDetectBounds} onChange={() => setTooltipShouldDetectBounds(!tooltipShouldDetectBounds)} />
