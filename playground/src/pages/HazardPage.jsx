...
const HazardPage = () => {
  ...
  const curves = filterMultipleCurves(['PGA'], hazardChartsData, hazardPageOption.locations[0], hazardPageOption.forecastTimes[0], hazardPageOption.gmpe[0], hazardPageOption.backgroundSeismicity[0]);
  console.log(curves);
  ...
  return (
    <>
      ...
      <div style={{ border: 'solid black 1px', width: '100vw' }}>
        <HazardCurves curves={curves} width={500} scalesConfig={scalesConfig} colors={colors} heading={'Static Hazard Curves'} subHeading={'subHeading'} />
      </div>
      <div style={{ border: 'solid black 1px', width: '100vw', display: 'flex', justifyContent: 'center' }}>
        <div style={{ width: '50vw', display: 'flex', justifyContent: 'center' }}>
          <ResponsiveHazardCurves curves={curves} scalesConfig={scalesConfig} colors={colors} heading={'Responsive Hazard Curves'} subHeading={'subHeading'} />
        </div>
      </div>
    </>
  );
